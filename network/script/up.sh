...
function up {
	...
	docker-compose -f ./docker-compose.yml up -d ca.example.com orderer.example.com zookeeper kafka0 peer0.MEDSOS.example.com couchdb api.MEDSOS.example.com cli webservices
